...
<c:if test="${!empty status}">
	...
	<label for="email">Book ID:</label> <input type="text" name="bookId" value="${bookId}" /><br><br>
	<label for="email">Book Name:</label> <input type="text" name="bookName" value="${book}" /><br><br>
	
	Enter Number of Book <br>
		<div class="value-button" id="decrease" onclick="decreaseValue()"
			value="Decrease Value">-</div>
		<input type="number" id="number" value="${bookNumbers}" name="bookCount" />
